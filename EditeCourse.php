...
include_once('DB_Connection.php');
  $Err = " "; $result=" "; 
      ...
      /* if ($result) {
        echo'<div class="row"><div class="col-12"><div class="alert alert-success">
         course edited </div></div></div>';
       //   header("location:edit_student.php"."?id=$id");
        }else{
        echo'<div class="row"><div class="col-12"><div class="alert alert-danger">
        Faild to edit course </div></div></div>';
        }
    } */
                ...
                <div class="bg-light text-center rounded p-4">
                    ...
                    <form action="<?php $_SERVER['PHP_SELF'] . '?id=' . $_GET['id'] ?>" method="post">
                        ...
                        <div class="row mb-3">
                            ...
                            <?php
                    echo "<select  name='teacher_id' class='select' >";
